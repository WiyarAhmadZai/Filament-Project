...
@section('title', 'Afghanistan Tourism - Blog Category: ' . $category)

@section('content')
    <!-- Category Hero Section -->
    <section class="py-5">
        <div class="container text-center">
            <h1 class="display-5 fw-bold mb-4" data-aos="fade-up">Category: {{ ucfirst($category) }}</h1>
            <p class="lead text-muted mb-5" data-aos="fade-up" data-aos-delay="200">
                Explore articles about {{ $category }} in Afghanistan
            </p>
        </div>
    </section>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <h5 class="card-title fw-bold mb-3">Exploring the Wakhan Corridor: A Journey Through
                                        Afghanistan's Hidden Valley</h5>
                                    <p class="card-text text-muted mb-4">Discover one of Afghanistan's most remote and
                                        breathtaking regions, where ancient traditions meet stunning natural beauty.</p>
                                    <a href="{{ route('blog.post', 'exploring-wakhan-corridor') }}"
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="400">
                            <div class="card border-0 shadow-sm h-100">
                                <img src="{{ asset('img/20240524_152758kk.jpg') }}" alt="Blog Post 2" class="card-img-top">
                                <div class="card-body p-4">
                                    <div class="d-flex mb-3">
                                        <span class="badge bg-primary me-2">{{ ucfirst($category) }}</span>
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="600">
                            <div class="card border-0 shadow-sm h-100">
                                <img src="{{ asset('img/20241231_222751.jpg') }}" alt="Blog Post 3" class="card-img-top">
                                <div class="card-body p-4">
                                    <div class="d-flex mb-3">
                                        <span class="badge bg-primary me-2">{{ ucfirst($category) }}</span>
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="800">
                            <div class="card border-0 shadow-sm h-100">
                                <img src="{{ asset('img/20240524_152758kk.jpg') }}" alt="Blog Post 4" class="card-img-top">
                                <div class="card-body p-4">
                                    <div class="d-flex mb-3">
                                        <span class="badge bg-primary me-2">{{ ucfirst($category) }}</span>
